...
defmodule Mnesia.RepoTest.Macros do
  defmacro shared_examples(module) do
    quote do
      @described_module unquote(module)
      ...
      describe "Mnesia.Repo.create_table/0" do
        ...
        test "creates the mnesia table" do
          ...
          assert @described_module == :mnesia.table_info(unquote(module), :record_name)
        end
      end
...
defmodule Mnesia.RepoTest do
  ...
  Mnesia.RepoTest.Macros.shared_examples(DummyModel)
end
