...
export async function svg2image(svg: SVGSVGElement, color: string): Promise<bs.Image> {
  ...
  const promise: Promise<bs.Image> =
...
export async function loadImage(id: string, color: string): Promise<bs.Image> {
