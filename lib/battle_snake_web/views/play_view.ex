defmodule BattleSnakeWeb.PlayView do
  ...
  def battle_snake_js_object(assigns, _ \\ %{}) do
    Phoenix.View.render(BattleSnakeWeb.BoardConfigView, "show.json", assigns)
    |> Poison.encode!
  end
end
